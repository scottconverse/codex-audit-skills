...
This is the full single-file audit-team workflow adapted for Codex. References and templates are bundled in this skill directory so the original reference links resolve inside Codex.
